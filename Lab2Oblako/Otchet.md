...
Классифицировать сервисы Microsoft было сложнее из-за запутанных формулировок на сайтах, но мы узнали про методы использования облак, о которых не думали до этого.
