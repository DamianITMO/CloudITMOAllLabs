...
1 - В докерфайле выдаются root-права. При непридвиденном поведении, наличие таких прав может нанести большой ущерб окружению.
...
3 - В докерфайле не прописано куда имеено будут устанавливаться файлы, поэтому установка может произойти куда-попало.
