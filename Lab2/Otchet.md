...
Для того чтобы не запускать просто программу «Hello World», мы скачали из интернета случайную программу на Python
и решили сделать докерфайл на основе неё. 

![image](1.bmp)
![image](2.bmp)

На основе этого нормального докерфайла мы сделали вот этоn убогий докерфайл:
